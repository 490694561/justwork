...
//	unsigned __int8 m[]={51,103,51,82,158,143,16,87};
	for(number=0xFFFFFEFF;number>=0;number--)
	{
		j=0x1D8;j1=0;
		i=number;
//		i=0xFFFFFEFF;
...
int cmp_miwen(unsigned __int8 *m,char *mima_1,char *mima_2,char *mima_3)
{
	...
	do
	{
		if(mima_2[8*((((m[7]%0x100)>>v5)&1)+(((m[6]%0x100)>>v5)&1)+(((m[5]%0x100)>>v5)&1)+(((m[4]%0x100)>>v5)&1)+(((m[3]%0x100)>>v5)&1)+(((m[2]%0x100)>>v5)&1)+((result>>v5)&1)+((v6>>v5)&1))-v5]==36)
		{
			++v1;
		}
		--v5;
